...
|---|---|---|---:|---:|---|---|---|
| Stable | `Dockhand by JigSawFr` | `https://github.com/JigSawFr/dockhand-ha-addon` | `main` | `1.0.48.1` | `X.Y.Z`, `X.Y.Z.N` | `<version>`, `latest` | regular |
| Beta | `Dockhand Beta by JigSawFr` | `https://github.com/JigSawFr/dockhand-ha-addon#dev` | `dev` | `1.0.48.2-beta.1` | `X.Y.Z.N-beta.M` | `<version>`, `beta` | prerelease |
